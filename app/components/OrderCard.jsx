  ...
  return (
     <div className="mt-6 md:mt-14 max-w-7xl mx-auto">
      <div className="flex justify-center items-center gap-3.5 mb-2">
        ...
        <h1 className="font-playfair text-center text-2xl font-semibold">Ordering Process</h1>
      </div>
      <div className="font-inter bg-[#F8F5F0] grid md:grid-cols-4 md:gap-14 gap-6 mt-10">
        {odercarddata.map((data) => {
          return (
            ...
            >
              ...
              <h2 className="text-lg font-light tracking-wide text-neutral-900">
                {data.heading}
              </h2>
